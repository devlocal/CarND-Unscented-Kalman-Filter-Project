    ...
    if (length > 2 && data[0] == '4' && data[1] == '2')
    {
      ...
      if (!s.empty()) {
        ...
        if (event == "telemetry") {
          ...
          // There are 249 data samples
          if (ukf.nis_lidar_.GetData().size() == 249) {
            ukf.nis_lidar_.WriteToFile("../nis_data/lidar.txt");
            ukf.nis_radar_.WriteToFile("../nis_data/radar.txt");
          }
        }
      } else {
        std::string msg = "42[\"manual\",{}]";
